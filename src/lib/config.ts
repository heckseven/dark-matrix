...
const HudWidgetSchema = z.discriminatedUnion('widget', [
  ...
  z.object({ widget: z.literal('audio'), style: z.enum(['vu-glitch', 'circuit', 'spirits', 'scope-dual', 'kick-d', 'waterfall', 'sparks', 'hex', 'specter', 'heat', 'dark-matter', 'spectrum-fall', 'neo', 'cipher', 'wake', 'rhythm', 'drop', 'life-erode-4', 'life-erode-4b', 'life-erode-4c', 'life-erode-4e', 'life-erode-4ec', 'glitch-sort-b', 'spiral-d', 'strobe', 'glitch-corrupt']).optional() }),
]);
