...
const HudWidgetSchema = z.discriminatedUnion('widget', [
  ...
  z.object({ widget: z.literal('data'), style: z.enum(['line', 'fill', 'scroll', 'cores', 'gpufire']).optional().catch(undefined), top_left: z.enum(['cpu', 'ram', 'net_rx', 'net_tx']).optional(), top_right: z.enum(['cpu', 'ram', 'net_rx', 'net_tx']).optional(), bottom_left: z.enum(['cpu', 'ram', 'net_rx', 'net_tx']).optional(), bottom_right: z.enum(['cpu', 'ram', 'net_rx', 'net_tx']).optional() }),
