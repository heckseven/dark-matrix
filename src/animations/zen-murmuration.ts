...
const COH_WEIGHT    = 20;
const GLOBAL_COH    = 2;    // near-zero — centroid attractor causes swarming, not murmuration
...
const V_PAD_X       = 34;   // virtual cols beyond each display edge (boids swoop off/on)
const V_PAD_Y       = 22;   // virtual rows beyond top/bottom of display
