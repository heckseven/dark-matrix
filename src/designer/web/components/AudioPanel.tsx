...
const PLACEHOLDER: Record<AudioStyle, string> = {
  ...
  'life-erode':      makeFrame((c, r) => (c * 19 + r * 37 + c * r * 5) % 13 < 4 ? 255 : 0),
  'life-erode-2':    makeFrame((c, r) => (c * 19 + r * 37 + c * r * 5) % 13 < 3 ? 255 : 0),
  'life-erode-3':    makeFrame((c, r) => (c * 19 + r * 37 + c * r * 5) % 13 < 2 ? 255 : 0),
