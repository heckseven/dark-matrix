  ...
  return (
    <div
      ...
      onDrop={e => {
        ...
        if (to !== from) deckStore.getState().moveFrame(from, to);
      }}
    >
      {showDrop ? (
        ...
        <>
          ...
          <Button
            ...
            onClick={() => deckStore.getState().addFrame(afterIdx)}
          >
            +
          </Button>
          <div className="flex-1 h-px bg-border" />
...
function FrameCell({
  ...
  return (
    <div
      ...
      onClick={() => deckStore.getState().setActiveFrame(idx)}
      onKeyDown={e => {
        if (e.key === 'Enter' || e.key === ' ') {
          e.preventDefault();
          deckStore.getState().setActiveFrame(idx);
        }
      }}
      onDragOver={e => {
        e.preventDefault();
  ...
  return (
    ...
    >
      ...
      <Button
        ...
        tooltip="Add frame"
        onClick={() => { const s = deckStore.getState(); s.addFrame(s.activeFrameIdx); }}
      >
        +
      </Button>
    </div>
