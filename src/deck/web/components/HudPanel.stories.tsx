...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Three-column HUD preset editor. Left: scrollable preset list. Center: dual live preview with clickable L/R regions. Right: widget inspector for the selected side.',
      },
    },
  },
...
export const Playground: Story = {
  decorators: [
    (Story) => {
      ...
      deckStore.setState({ hudPresets: [], activePresetName: null, selectedPresetName: 'default', hudSelectedSide: 'left' });
      return (
...
export const RightSideSelected: Story = {
  decorators: [
    (Story) => {
      ...
      deckStore.setState({ hudPresets: [], activePresetName: null, selectedPresetName: null, hudSelectedSide: 'right' });
      return (
        <div style={{ height: '100vh', padding: '1rem', boxSizing: 'border-box' }}>
          <Story />
        </div>
